        ...
        <div class="flex flex-1 flex-col p-5">
            ...
            <div class="mt-auto flex items-center justify-between gap-3 border-t border-gray-100 pt-4">
                <a 
                  ...
                  class="flex-1 rounded-lg bg-yellow-500 px-4 py-2.5 text-center text-sm font-semibold text-white hover:bg-yellow-600 transition cursor-pointer">
                  Detalhes
                </a>
                ...
                <form action="{{ route('site.addcarrinho') }}" method="POST" enctype="multipart/form-data" class="flex-1">
                  ...
                  <button 
                    type="submit"
                    class="w-full rounded-lg bg-blue-600 px-4 py-2.5 text-sm font-semibold text-white hover:bg-blue-700 transition cursor-pointer">
                    Comprar
                  </button>
                </form>
            </div>
