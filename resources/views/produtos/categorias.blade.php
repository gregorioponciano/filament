        ...
        <div class="flex flex-1 flex-col p-5 bg-card-primary">
            ...
            <div class="flex items-center justify-between mt-auto pt-4 border-t border-gray-100">
                ...
                <form action="{{ route('site.addcarrinho') }}" method="POST">
                    ...
                    <button type="submit" class="rounded-lg bg-button-primary px-4 py-2.5 hover:bg-hover-primary transition cursor-pointer" title="Adicionar ao Carrinho">Comprar</button>
                </form>
            </div>
        </div>
